  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button 
          variant="outline" 
          className="w-full justify-between h-14 px-4 bg-white hover:bg-gray-50"
          style={{ borderColor: linhaSelecionada.corHex, borderWidth: '2px' }}
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-gray-500">Clique para trocar de linha</p>
            </div>
          </div>
